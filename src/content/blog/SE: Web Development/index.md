...
## Project 1A: Information Structure Exercise
...
Use a text editor and design a **structured document**, containing an about you section, an eassy on:
...
*you know what, the rest is in my git hub, just go to: (https://github.com/peterktsitsi)*
